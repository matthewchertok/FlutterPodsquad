    ...
    return Container(
      child: Padding(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.end, children: [
          // My name, if it's a pod message
          if (isPodMode)
            Padding(padding: EdgeInsets.only(right: 5, bottom: 5), child: Text(
              myName,
    ...
    return Container(
      child: Padding(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          // The chat partner name
          if (isPodMode)
            Padding(padding: EdgeInsets.only(left: 5, bottom: 5), child: Text(
