      ...
      children: [
          ...
          if (personData.extraImagesList?.isNotEmpty ?? false)
            ListTile(
              ...
              CupertinoColors.darkBackgroundGray)),
              leading: Icon(CupertinoIcons.photo, color: CupertinoColors.inactiveGray),
              onTap: () {
          ...
          if (didLikeUser)
            ListTile(
              ...
              CupertinoColors.darkBackgroundGray)),
              leading: Icon(CupertinoIcons.heart_slash, color: CupertinoColors.inactiveGray),
              onTap: () {
          ...
          if (!didFriendUser)
            ListTile(
              ...
              CupertinoColors.darkBackgroundGray)),
              leading: Icon(CupertinoIcons.person_badge_plus, color: CupertinoColors.inactiveGray),
              onTap: () {
          ...
          if (didFriendUser)
            ListTile(
              ...
              CupertinoColors.darkBackgroundGray)),
              leading: Icon(CupertinoIcons.person_badge_minus, color: CupertinoColors.inactiveGray),
              onTap: () {
          ...
          if (didBlockUser)
            ListTile(
              ...
              CupertinoColors.darkBackgroundGray)),
              leading: Icon(CupertinoIcons.hand_raised_slash, color: CupertinoColors.inactiveGray),
              onTap: () {
          ...
          if (!didReportUser)
            ListTile(
              ...
              CupertinoColors.darkBackgroundGray)),
              leading: Icon(CupertinoIcons.exclamationmark_shield, color: CupertinoColors.inactiveGray),
              onTap: () {
          ...
          if (didReportUser)
            ListTile(
              ...
              CupertinoColors.darkBackgroundGray)),
              leading: Icon(CupertinoIcons.shield_slash, color: CupertinoColors.inactiveGray),
              onTap: () {
                // "Are you sure you want to report [NAME]?"
                final reportAlert = CupertinoAlertDialog(
