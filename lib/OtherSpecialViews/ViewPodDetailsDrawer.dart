...
PodData podData, required Function
joinPodFunction, required Function leavePodFunction, required Function deletePodFunction})
=>
    Drawer(child:
SafeArea(child: ListView(padding: EdgeInsets
    .zero, children: [
  DrawerHeader(
...
// For convenience, also show a Join Pod option if I'm not a member. THe difference between the other
  ...
  if (amMemberOfPod && podData.podCreatorID == myFirebaseUserId)
    ListTile(title: Text("Delete Pod", style: TextStyle(color: CupertinoColors.destructiveRed),), leading: Icon(CupertinoIcons
